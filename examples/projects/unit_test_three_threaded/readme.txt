...
-----------------
  ...
  4. cd <projects root>
  5. %grail_python2_x_exe% %grail42_root%\templates\tools\python_2_x\clonetree.py %grail42_root%\templates\examples\projects\unit_test_three_threaded
  
    Modify the file that appears in notepad to be:

net\examples\unit_test_three_threaded<-===->net\examples\mytest
net.examples.unit_test_three_threaded<-===->net.examples.mytest
unit_test_three_threaded<-===->mytest
net_examples_unit_1test_1three_1threaded<-===->net_examples_mytest
