...
#include <g42core/test/main_three_threaded.hpp>

int faux_main()
{
    return G42CORE_TEST_RUN_TESTS_THREE_THREADED();
}
...
extern "C" JNIEXPORT jint JNICALL Java_net_examples_unit_1test_1three_1threaded_FauxConsole_main(JNIEnv * env, jobject  obj)
{
